...
CREATE TABLE IF NOT EXISTS `MYSHOP22`.`Manager` (
  ...
  INDEX `fk_Manager_Point_shop1_idx` (`Point_shop_idPoint_shop` ASC) VISIBLE,
  CONSTRAINT `fk_Manager_Point_shop1`
...
CREATE TABLE IF NOT EXISTS `MYSHOP22`.`Shop_List` (
  ...
  INDEX `fk_Shop_List_articolo1_idx` (`articolo_idarticolo` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_BUY_List_Cliente1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Shop_List_articolo1`
    FOREIGN KEY (`articolo_idarticolo`)
    REFERENCES `MYSHOP22`.`articolo` (`idarticolo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
